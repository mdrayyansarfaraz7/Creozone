  ...
  return (
    (<div className="[perspective:1200px] [transform-style:preserve-3d]">
      <li
        ...
        <div
          className="absolute top-0 left-0 w-full h-full bg-[#32394f] rounded-[1%] overflow-hidden transition-all duration-150 ease-out"
          style={{
            transform:
              current === index
        ...
        >
          <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-semibold relative font-oswald text-left">
            {title}
          </h2>
          <p className="text-sm sm:text-xl text-neutral-300 mt-2 text-left font-lato">
            Discover new design ideas, trends, and creative inspirations.
          </p>
...
export function Carousel({ slides, onSlideChange }) {
